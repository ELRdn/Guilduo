...
| Error de permisos `agents:read` | Vuelve a autorizar la conexión y confirma el permiso de lectura de Agents en la pantalla de consentimiento. La configuración del Agent no puede añadir permisos OAuth. |
